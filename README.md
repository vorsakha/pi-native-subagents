...
- Smoothly fading active-job dots in conversation thread cards, `/subagents`, and takeover, with live status, cancellation, steering, queued follow-ups, and normalized user/assistant/thinking/tool state.
