...
- `/subagents` TUI dashboard with slowly pulsing active-job dots, live status, cancellation, steering, queued follow-ups, and Enter-to-open interactive takeover with normalized user/assistant/thinking/tool state.
