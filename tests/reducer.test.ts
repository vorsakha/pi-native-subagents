...
function job(): JobSnapshot {
  return { id: "j", role: "worker", backend: "codex", model: "m", task: "t", cwd: "/tmp", status: "queued", generation: 0, createdAt: 1, output: "", truncated: false, usage: emptyUsage(), tools: [], transcript: [], liveThinking: "", queuedMessages: [] };
}
